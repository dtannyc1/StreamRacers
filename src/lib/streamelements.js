...
export const getRacersAndTracks = async (token, channelId, hardReset = false) => {
  ...
  const [racers, tracks] = await Promise.all([
    ...
    initIfMissing('raceHistoryOverlaySettings')
  ])
...
export const getRaceHistoryOverlaySettings = async (token, channelId) =>
  getKVKey(token, channelId, 'raceHistoryOverlaySettings')
    ...
    "widgets": [
        {
            ...
            "variables": {
                ...
                "html": "<script type=\"module\" src=\"https://streamracers.onrender.com/RaceHistory.js\"></script>   \n\n<div id=\"refresh-flash\"></div>\n<div id=\"overlay\">\n  <div id=\"panels\"></div>\n</div>",
                "js": "",
                "fields": "{}"
            },
            "provider": "twitch"
