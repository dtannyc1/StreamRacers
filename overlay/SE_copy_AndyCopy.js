...
let customRacers = {"EnigmaticGnu":{}, "KnuthingIsReal":{}, "BuddyHott":{},
            ...
            .then(data => {
                ...
                if (customRacers[name]){
                  ...
                  let keys = ["avatarTL", "avatarDIM",
					...
					"wheel1", "wheel1TL", "wheel1DIM", "wheel1CR", "wheel1Theta", "wheel1Radius",
					"wheel2", "wheel2TL", "wheel2DIM", "wheel2CR", "wheel2Theta", "wheel2Radius",
					"customDraw"]
                  for (let key of keys){
