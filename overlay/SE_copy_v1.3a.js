...
let testRacers = [];
if (testing){
  testRacers = ["apocalypse_squirrel", "KnuthingIsReal", "NowImABeliever",
...
let customRacers = {"NowImABeliever":{}, "albinounounou":{}, "EnigmaticGnu":{}, "KnuthingIsReal":{}, "BuddyHott":{},
                    "Fareeha":{}, "fridolin":{}, "MatMan2855":{}, "OmegaPrimal":{},
                   "Verth987":{}, "pencils45":{}, "DpOblivion":{}};
  	...
  	for (let name of sortedRacers){
      	...
      	if (racer){
            ...
            if (racer.vehicle) {
                  ...
                  if (racer.showBoost) {
                    if (racer.boost.naturalWidth) ctx.drawImage(racer.boost, ...racer.boostTL, ...racer.boostDIM);
                  }
                  if (racer.vehicle.naturalWidth) ctx.drawImage(racer.vehicle, ...racer.vehicleTL, ...racer.vehicleDIM);
                  ...
                  if (racer.wheel1 && racer.wheel1.naturalWidth) ctx.drawImage(racer.wheel1, ...racer.wheel1TL, ...racer.wheel1DIM); // draw wheel 1
                  ...
                  if (racer.wheel2 && racer.wheel2.naturalWidth) ctx.drawImage(racer.wheel2, ...racer.wheel2TL, ...racer.wheel2DIM);
        ...
        let url = "https://api.twitch.tv/helix/users?login=" + name;
       	await fetch(url, {
            ...
            .then(data => {
                ...
                if (customRacers[name]){
                  setupCustomRacer(name);
                  let keys = ["avatarTL", "avatarDIM",
					"vehicle", "vehicleTL", "vehicleDIM", "vehicleCR", "flyingHeight",
					...
					"customDraw", "customUpdate"]
                  for (let key of keys){
                      racer[key] = customRacers[name][key];
                  }
                } else {
                ...
                // racer location
                racer.XY = [-1920 - Math.random()*1920/2, 1080 - 25 - Math.random()*totalRoadHeight];
...
function setupCustomRacer(name){
  let custom = {};
	switch (name){
		case "EnigmaticGnu":
			let gnu = {};
      ...
      gnu.vehicle = new Image();
      gnu.vehicle.src = "https://www.dropbox.com/scl/fi/aryx4tbgseo1a30anl1bw/Gnu_vehicle.png?rlkey=fd6q1lxuvkvxtcr7xaucsyaxf&raw=1";
      ...
      gnu.wheel1 = new Image();
      gnu.wheel1.src = "https://www.dropbox.com/scl/fi/208taq1jj3ai4pfv2u3x6/Gnu_left_wheel.png?rlkey=xoss52eu7ox9os6djl8c1wks1&raw=1";
      ...
      gnu.wheel2 = new Image();
      gnu.wheel2.src = "https://www.dropbox.com/scl/fi/8mwt0iahsscb2mj9dwtlo/Gnu_right_wheel.png?rlkey=yagb5p6vx4xf2a76935xeqaqs&raw=1";
      gnu.wheel2TL = [-400-20, -200];
      gnu.wheel2DIM = [400, 200];
      gnu.wheel2CR = [-43-20,-15];
      gnu.wheel2Theta = Math.PI / 6;
      gnu.wheel2Radius = 15.5;
			customRacers["EnigmaticGnu"] = gnu;
			break;
    case "albinounounou":
      custom.avatarTL = [-200+130.857,-58-15.357];
      custom.avatarDIM = [58,58];

      custom.vehicle = new Image();
      custom.vehicle.src = "https://www.dropbox.com/scl/fi/cy3r6bq16ttqhhivpon3e/Albinounou_vehicle.png?rlkey=f4q7gqhi2d2an4p1e5whcyom7&raw=1";
      custom.vehicleTL = [-200+14, -200];
      custom.vehicleDIM = [200, 200];

      custom.showBoost = false;
      custom.boost = new Image();
      custom.boost.src = "https://www.dropbox.com/scl/fi/dictf55kycjq2ru95pyjy/Albinounou_boost.png?rlkey=us0bwia2bb77j1exva20lz627&raw=1";
      custom.boostTL = [-200+14, -200];
      custom.boostDIM = [200, 200];

      custom.wheel1 = new Image();
      custom.wheel1.src = "https://www.dropbox.com/scl/fi/yfipdnjeq7yps0jl8nrro/Albinounou_right_wheel.png?rlkey=d7681i9qn4sjj4fwisdrlbio3&raw=1";
      ...
      custom.wheel2 = new Image();
      custom.wheel2.src = "https://www.dropbox.com/scl/fi/zsnofkgne0jtai233r622/Albinounou_left_wheel.png?rlkey=ilqtrx2acbeplt40u47esectf&raw=1";
      ...
      break;
		case "BuddyHott":
			let buddy_hott = {};
				...
				buddy_hott.vehicle = new Image();
				buddy_hott.vehicle.src = "https://www.dropbox.com/scl/fi/y2cuoqgu6bqy3tgg0cmue/BuddyHott_vehicle.png?rlkey=tz10d0gsj9twuthruu7qw696x&raw=1";
		...
		case "DpOblivion":
			let dpoblivion = {};
				...
				dpoblivion.vehicle = new Image();
				dpoblivion.vehicle.src = "https://www.dropbox.com/scl/fi/exq3miarvdxzu5180osue/DpOblivion_vehicle.png?rlkey=b7hsvr8vejl75ylze8t2yztql&raw=1";
		...
		case "Fareeha":
			let fareeha = {};
				...
				fareeha.vehicle = new Image();
				fareeha.vehicle.src = "https://www.dropbox.com/scl/fi/ji1779c4qs20s13i3w69h/Fareeha_vehicle.png?rlkey=2iwnf9f9d3zl45qz4wyp5ndrg&raw=1";
				...
				fareeha.wheel1 = new Image();
				fareeha.wheel1.src = "https://www.dropbox.com/scl/fi/rrk4mz17axeuhzq3pieyk/Fareeha_left_wheel.png?rlkey=fhljllqo2k7x8oph5bq5echxs&raw=1";
				...
				fareeha.wheel2 = new Image();
				fareeha.wheel2.src = "https://www.dropbox.com/scl/fi/eek4fe6v0cifo1h77ebm3/Fareeha_right_wheel.png?rlkey=n4q3kiivu4zsff7qctp93rxk1&raw=1";
		...
		case "fridolin":
			let fridolin = {};
				fridolin.avatarTL = [-200+130.6,-50-89.67];
				fridolin.avatarDIM = [50, 50];

				fridolin.vehicle = new Image();
				fridolin.vehicle.src = "https://www.dropbox.com/scl/fi/77gm7tjml855uheu3ih10/Fridolin_vehicle.png?rlkey=7heat83nafftedgmbc219b8go&raw=1";
				fridolin.vehicleTL = [-200+6, -200];
				fridolin.vehicleDIM = [200, 200];

				fridolin.showBoost = false;
				fridolin.boost = defaultDrawings.boost;
				fridolin.boostTL = [-200-34.346, -124.74-40.195];
				fridolin.boostDIM = [161.917, 124.74];
			...
			customRacers["fridolin"] = fridolin;
			break;
		case "KnuthingIsReal":
			let num_vars = 4;
			...
			switch (val){
				case 0:
					let knu_0 = {};
						...
						knu_0.vehicle = new Image();
						knu_0.vehicle.src = "https://www.dropbox.com/scl/fi/0nw98ewn4scq0d5d4vfvd/Knu_vehicle_0.png?rlkey=5qh6bkcg2mbshatnehzfdna74&raw=1";
				...
				case 1:
					let knu_1 = {};
						...
						knu_1.vehicle = new Image();
						knu_1.vehicle.src = "https://www.dropbox.com/scl/fi/092r1pdo1m77ijvt3r5h3/Knu_vehicle_1.png?rlkey=33sat6i1lfoi8nxhgw3ymtj01&raw=1";
          ...
          knu_2.vehicle = new Image();
          knu_2.vehicle.src = "https://www.dropbox.com/scl/fi/xyv14vyx8rf7e5mgfzucl/Knu_vehicle_2.png?rlkey=g3rbzk3bw8y7bdfyeosprtq0p&raw=1";
        ...
        case 3:
          ...
          custom.vehicle = new Image();
          custom.vehicle.src = "https://www.dropbox.com/scl/fi/nagsvlqglf2qr45031rhc/Knu_vehicle_3_back.png?rlkey=ighaxdmv9vv1a9ni2gjhhhoh4&raw=1";
          ...
          custom.wheel1 = new Image();
          custom.wheel1.src = "https://www.dropbox.com/scl/fi/1mbtwnfipwlpipagjjk24/Knu_vehicle_3_front.png?rlkey=vh0jvvnb5qnk8b0avjmcnidg3&raw=1";
          ...
          custom.customDraw = () => {
            ...
            ctx.arc(...racer.avatarTL.map((val, ii) => val+racer.avatarDIM[ii]/2), racer.avatarDIM[0]/2, 0, Math.PI * 2, false)
            ctx.clip()
            if (racer.avatar?.naturalWidth) ctx.drawImage(racer.avatar, ...racer.avatarTL, ...racer.avatarDIM);
            ctx.closePath();
            ctx.restore();
            if (racer.wheel1?.naturalWidth) ctx.drawImage(racer.wheel1, ...racer.wheel1TL, ...racer.wheel1DIM);
          }
          customRacers[name] = custom;
          break;
      }
      break;
		case "MatMan2855":
			let matman = {};
				matman.avatarTL = [-200-26,-80-170.48];
				matman.avatarDIM = [80, 80];

				matman.vehicle = new Image();
				matman.vehicle.src = "https://www.dropbox.com/scl/fi/oebbnlx9iefzg06idnm0o/Matman_vehicle.png?rlkey=7p5z5zx6a4fh7wa803gtu0rup&raw=1";
				matman.vehicleTL = [-300-100+76, -300];
				matman.vehicleDIM = [300, 300];

				matman.showBoost = false;
				matman.boost = defaultDrawings.boost;
				matman.boostTL = [-259.6-80.41, -200-54.84];
			...
			break;
    	case "NowImABeliever":
        custom.avatarTL = [-200+54.043,-90-68.690];
        custom.avatarDIM = [90,90];

        custom.vehicle = new Image();
        custom.vehicle.src = "https://www.dropbox.com/scl/fi/zdumqm0vi19c0i43t7ojr/believer_vehicle_1.png?rlkey=93h7uvuuej2e3mfwkuef9g2np&raw=1";
        custom.vehicleTL = [-200, -200];
        custom.vehicleDIM = [200, 200];

        custom.showBoost = false;
        custom.boost = defaultDrawings.boost;
        custom.boostTL = [-200-60.099, -200+26.764];
        custom.boostDIM = [259.6, 200];

        custom.wheel1 = new Image();
        custom.wheel1.src = "https://www.dropbox.com/scl/fi/pj9pa63k6vxr4aaz8p0ur/believer_back_paw_back.png?rlkey=k06p470lkp9euhmjwpvhprmnp&raw=1";
        custom.wheel1TL = [-200, -200];
        custom.wheel1DIM = [200, 200];
        custom.wheel1CR = [-200+44.29,-30];
        custom.wheel1Theta = -Math.PI/4;
        custom.wheel1Radius = 30;
        custom.wheel1ThetaDot = -1;

        custom.wheel2 = new Image();
        custom.wheel2.src = "https://www.dropbox.com/scl/fi/jdba7bobcmww5uecu3ayl/believer_front_paw_back.png?rlkey=iq214rspjzcukfjsyprh9rnsz&raw=1";
        custom.wheel2TL = [-200, -200];
        custom.wheel2DIM = [200, 200];
        custom.wheel2CR = [-200+135.71,-30];
        custom.wheel2Theta = -Math.PI/8;
        custom.wheel2Radius = 30;
        custom.wheel2ThetaDot = -1;

        custom.wheel3 = new Image();
        custom.wheel3.src = "https://www.dropbox.com/scl/fi/r1boemiidjqnj2s8s4pel/believer_back_wheel_front.png?rlkey=08gzzbvy1swj05v8hyi5chg5j&raw=1";
        custom.wheel3TL = [-200, -200];
        custom.wheel3DIM = [200, 200];
        custom.wheel3CR = [-200+48.57,-25];
        custom.wheel3Theta = Math.PI/8;
        custom.wheel3Radius = 30;
        custom.wheel3ThetaDot = 1;

        custom.wheel4 = new Image();
        custom.wheel4.src = "https://www.dropbox.com/scl/fi/zgn2hle8twab8rfsiipb9/believer_front_wheel_front.png?rlkey=lj83ho7iqj4bazfydsnilqget&raw=1";
        custom.wheel4TL = [-200, -200];
        custom.wheel4DIM = [200, 200];
        custom.wheel4CR = [-200+136.07,-25];
        custom.wheel4Theta = 0;
        custom.wheel4Radius = 30;
        custom.wheel4ThetaDot = 1;
		...
		case "OmegaPrimal":
			let omega_primal = {};
				omega_primal.avatarTL = [-200+82.83,-54.286-70.48];
				omega_primal.avatarDIM = [54.286, 54.286];

				omega_primal.vehicle = new Image();
				omega_primal.vehicle.src = "https://www.dropbox.com/scl/fi/s4eeackyz3t70lzm8m5n1/omega_primal_vehicle.png?rlkey=0uonth8lg7u2ix106sy85450d&raw=1";
				omega_primal.vehicleTL = [-200-18, -200];
				omega_primal.vehicleDIM = [200, 200];

				omega_primal.showBoost = false;
				omega_primal.boost = defaultDrawings.boost;
				omega_primal.boostTL = [-200-100.4, -200+23.73];
				omega_primal.boostDIM = [259.6, 200];

				omega_primal.wheel1 = new Image();
				omega_primal.wheel1.src = "https://www.dropbox.com/scl/fi/ihbjqx0o3e1hxe3f26ry7/omega_primal_left_wheel.png?rlkey=chrvgpna9iacoomocpchrmt4e&raw=1";
				omega_primal.wheel1TL = [-200-18, -200];
				omega_primal.wheel1DIM = [200, 200];
				omega_primal.wheel1CR = [-200+39.3,-25];
				omega_primal.wheel1Theta = Math.PI / 6;
				omega_primal.wheel1Radius = 25;

				omega_primal.wheel2 = new Image();
				omega_primal.wheel2.src = "https://www.dropbox.com/scl/fi/yiz4dwwdf9enhnt4byd01/omega_primal_right_wheel.png?rlkey=e0rr9huukbzfvspl1y5v5y79v&raw=1";
				omega_primal.wheel2TL = [-200-18, -200];
				omega_primal.wheel2DIM = [200, 200];
				omega_primal.wheel2CR = [-200+136.43,-25];
				omega_primal.wheel2Theta = Math.PI / 6;
				omega_primal.wheel2Radius = 25;
			customRacers["OmegaPrimal"] = omega_primal;
			break;
		case "pencils45":
			let pencils = {};
				pencils.avatarTL = [-200+50.12,-80-127.98];
				pencils.avatarDIM = [80,80];

				pencils.vehicle = new Image();
				pencils.vehicle.src = "https://www.dropbox.com/scl/fi/3h712p5dcbxmo4qbltnhh/pencils45_vehicle.png?rlkey=z7jvyuhbtz958eq8e1g6qul15&raw=1";
				pencils.vehicleTL = [-200-12, -200];
				pencils.vehicleDIM = [200, 200];

				pencils.showBoost = false;
				pencils.boost = defaultDrawings.boost;
				pencils.boostTL = [-200-47.4, -200+20.87];
				pencils.boostDIM = [259.6, 200];

				pencils.wheel1 = new Image();
				pencils.wheel1.src = "https://www.dropbox.com/scl/fi/o9dhmova2vqdo56agebr0/pencils_left_wheel.png?rlkey=cxmxekhip0k6zofitaalnnyis&raw=1";
				pencils.wheel1TL = [-200-12, -200];
				pencils.wheel1DIM = [200, 200];
				pencils.wheel1CR = [-200+67.5,-15];
				pencils.wheel1Theta = Math.PI / 6;
				pencils.wheel1Radius = 15;

				pencils.wheel2 = new Image();
				pencils.wheel2.src = "https://www.dropbox.com/scl/fi/akt9or2dsgyqqyean2tg9/pencils_right_wheel.png?rlkey=o71katukimcj6m1kwy7pu5ipc&raw=1";
				pencils.wheel2TL = [-200-12, -200];
				pencils.wheel2DIM = [200, 200];
				pencils.wheel2CR = [-200+125.71,-19.29];
				pencils.wheel2Theta = Math.PI / 6;
				pencils.wheel2Radius = 19.29;
			...
			customRacers["pencils45"] = pencils;
			break;
		case "Verth987":
			let verth = {};
				...
				verth.vehicle = new Image();
				verth.vehicle.src = "https://www.dropbox.com/scl/fi/wh2vmh1lsitdasyv6ewd4/verth_vehicle.png?rlkey=jbmay3ojkfp911cood8iqgbil&raw=1";
